; ModuleID = 'dist6.c'
source_filename = "dist6.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nounwind uwtable
define i32 @foo([1000 x i32]* %A, [1000 x i32]* %B) #0 {
entry:
  %A.addr = alloca [1000 x i32]*, align 8
  %B.addr = alloca [1000 x i32]*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  store [1000 x i32]* %A, [1000 x i32]** %A.addr, align 8
  store [1000 x i32]* %B, [1000 x i32]** %B.addr, align 8
